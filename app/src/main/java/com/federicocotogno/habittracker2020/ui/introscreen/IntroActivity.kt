...
class IntroActivity : AppCompatActivity() {
    ...
    private fun addToIntroView() {
        ...
        introView = listOf(
            IntroView("Welcome to Habit Tracker!", R.drawable.ic_football),
            IntroView("This app is designed to keep track of your habits, " +
                    "whether it's a good one, or a bad one.", R.drawable.ic_fastfood),
            IntroView("Good luck! Tap on the button below to get started with using the app!", R.drawable.ic_sleep),
        )
    }
}
