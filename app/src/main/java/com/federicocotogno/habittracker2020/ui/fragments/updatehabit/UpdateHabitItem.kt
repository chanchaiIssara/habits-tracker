...
class UpdateHabitItem : Fragment(R.layout.fragment_update_habit_item),
    ...
    private fun drawableSelected() {
        iv_FoodSelected_update.setOnClickListener {
            iv_FoodSelected_update.isSelected = !iv_FoodSelected_update.isSelected
            drawableSelected = R.drawable.ic_football

            //de-select the other options when we pick an image
            iv_footballSelected_update.isSelected = false
            iv_sleepSelected_update.isSelected = false
        }

        iv_footballSelected_update.setOnClickListener {
            iv_footballSelected_update.isSelected = !iv_footballSelected_update.isSelected
            drawableSelected = R.drawable.ic_fastfood

            //de-select the other options when we pick an image
            iv_FoodSelected_update.isSelected = false
            iv_sleepSelected_update.isSelected = false
        }
